...
//     const response = await register(`${baseUrl}/auth/register`, {
//       method: "POST",
...
//       localStorage.setItem("user", response.data.usesr);
//       router.push("/");
//     } else {
//     }
//   };
...
//           >
//             <div className="mb-6 text-center text-4xl font-bold">Sign up</div>
